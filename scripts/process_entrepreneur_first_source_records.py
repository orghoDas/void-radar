#!/usr/bin/env python3
"""Normalize and link Entrepreneurs First source records."""
...
from app.services.identity_resolution import process_entrepreneur_first_source_records
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Maximum number of Entrepreneurs First source records to process.",
    )
    ...
    db = session_factory()
    try:
        summary = process_entrepreneur_first_source_records(db, limit=args.limit)
    finally:
        db.close()
